...
export const mockVenues: Venue[] = [
  {
    ...
    name: 'Razzmatazz',
    type: 'club',
    description: 'Uno de los clubes más emblemáticos de Barcelona con 5 salas y programación variada.',
    capacity: 2000,
    city: 'Barcelona',
    country: 'España',
    avatar: 'https://images.unsplash.com/photo-1566737236500-c8ac43014a67?w=800',
    images: [
    ...
    reviewCount: 328,
    priceRange: 'medium',
    features: ['5 salas', 'Terraza', 'Parking'],
  },
  {
    id: 'v2',
    userId: 'u9',
    name: 'Sala Apolo',
    type: 'concert_hall',
    description: 'Histórica sala de conciertos en el corazón del Raval. Perfecta para shows en vivo.',
    capacity: 1200,
    city: 'Barcelona',
    country: 'España',
    avatar: 'https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=800',
    images: [
    ...
    reviewCount: 256,
    priceRange: 'medium',
    features: ['Sonido profesional', 'Backstage amplio', 'Camerinos'],
  },
  {
    id: 'v3',
    userId: 'u10',
    name: 'La Terrazza',
    type: 'rooftop',
    description: 'Club al aire libre con vistas espectaculares. Solo abre en temporada de verano.',
    capacity: 800,
    city: 'Barcelona',
    country: 'España',
    avatar: 'https://images.unsplash.com/photo-1598387180437-54e04a41d3bb?w=800',
    images: [],
    rating: 4.5,
    reviewCount: 189,
    priceRange: 'high',
    features: ['Aire libre', 'Vistas al mar', 'VIP area'],
  },
  {
    id: 'v4',
    userId: 'u11',
    name: 'Joy Eslava',
    type: 'club',
    description: 'Discoteca legendaria en el centro de Madrid. Más de 40 años de historia.',
    capacity: 1500,
    city: 'Madrid',
    country: 'España',
    avatar: 'https://images.unsplash.com/photo-1545128485-c400e7702796?w=800',
    images: [],
    rating: 4.3,
    reviewCount: 412,
    priceRange: 'medium',
    features: ['Céntrico', 'Histórico', 'Múltiples ambientes'],
  },
  {
    id: 'v5',
    userId: 'u12',
    name: 'Café del Mar',
    type: 'bar',
    description: 'El sunset bar más famoso del mundo. Ambiente chill y música selecta.',
    capacity: 300,
    city: 'Ibiza',
    country: 'España',
    ...
    reviewCount: 876,
    priceRange: 'premium',
    features: ['Vistas al atardecer', 'Terraza', 'Chill out'],
  },
  {
    id: 'v6',
    userId: 'u13',
    name: 'Pachá',
    type: 'club',
    description: 'El club más icónico de Ibiza. Noches legendarias desde 1973.',
    capacity: 3000,
    city: 'Ibiza',
    country: 'España',
    avatar: 'https://images.unsplash.com/photo-1571266028243-e4733b0f0bb0?w=800',
    images: [],
    rating: 4.6,
    reviewCount: 654,
    priceRange: 'premium',
    features: ['Club icónico', 'VIP tables', 'Main room + terrace'],
  },
  {
    id: 'v7',
    userId: 'u14',
    name: 'Teatro Barceló',
    type: 'theater',
    description: 'Antiguo teatro reconvertido en club nocturno con arquitectura impresionante.',
    capacity: 900,
    city: 'Madrid',
    country: 'España',
    avatar: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=800',
    images: [],
    rating: 4.4,
    reviewCount: 298,
    priceRange: 'high',
    features: ['Arquitectura única', 'Escenario', 'Balcones'],
  },
  {
    id: 'v8',
    userId: 'u15',
    name: 'Florida 135',
    type: 'club',
    description: 'Uno de los clubs más grandes de España. Templo del techno en Aragón.',
    capacity: 4000,
    city: 'Zaragoza',
    country: 'España',
    avatar: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=800',
    images: [],
    rating: 4.7,
    reviewCount: 445,
    priceRange: 'medium',
    features: ['Mega club', 'Sistema de sonido Funktion-One', 'Parking gratuito'],
  },
];
...
export const cities: Record<string, string[]> = {
  'España': ['Madrid', 'Barcelona', 'Valencia', 'Sevilla', 'Bilbao', 'Ibiza', 'Zaragoza'],
